...
CREATE OR REPLACE FUNCTION guess_country(a_name text) RETURNS text AS $$
    WITH u AS (
        SELECT 'Ukraine' AS iso,        array['ua', 'украина', 'ukrain', 'ukraina', 'україна', 'ukrine', 'ukriane', 'kiev'] AS variants UNION ALL
        SELECT 'Belarus',               array['by', 'беларусь'] UNION ALL
        ...
        SELECT 'United Kingdom',        array['gb', 'англия', 'england', 'britain', 'uk'] UNION ALL
        ...
        SELECT 'Dominica', array['dm'] UNION ALL
        ...
        SELECT 'Moldova, Republic Of',  array['md', 'молдова'] UNION ALL
